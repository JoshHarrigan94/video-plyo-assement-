...
function readVideoMetadata(objectUrl) {
  return new Promise((resolve, reject) => {
    ...
    video.onloadedmetadata = () => {
      ...
      /*
        Browser video metadata does not reliably expose true FPS.

        For now we use a conservative placeholder estimate.
        Later we can replace this with:
        - WebCodecs frame inspection
        - decoded frame timestamp sampling
        - MediaInfo-style metadata parsing
      */
      const fps = 30;
